-- killaura v5 | no-weapon-cfg | instant-impact | predict | no-fallback | no-wall-check
--[[
...
-- v5: fallback УДАЛЁН. Если svc не найден — это реальная ошибка, не молчим.
local function fallbackMeleeSwing()
    error("[KA FATAL] fallbackMeleeSwing вызван — svc/actor/Action недоступны. Проверь bridge/InventoryService структуру.")
end
